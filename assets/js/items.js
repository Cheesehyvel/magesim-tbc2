...
var equip = {
    weapon: [
        ...
        { id: 34987, title: "Brutal Gladiator's Battle Staff", int: 50, sp: 266, crit: 50, hit: 32, twohand: true },
        ...
        { id: 33494, title: "Amani Divining Staff", int: 47, sp: 217, crit: 31, twohand: true, sockets: ["r", "y", "b"], bonus: { sp: 5 } },
        ...
        { id: 33763, title: "Vengeful Gladiator's Spellblade", int: 20, sp: 247, hit: 17 },
        { id: 24557, title: "Gladiator's War Staff", twohand: true, int: 35, sp: 199, crit: 36, hit: 21 },
        { id: 33467, title: "Blade of Twisted Visions", int: 21, sp: 229, haste: 21 },
        { id: 33354, title: "Wub's Cursed Hexblade", int: 21, sp: 217, crit: 20, hit: 13, mp5: 6 },
    ...
    off_hand: [
        ...
        { id: 32361, title: "Blind-Seers Icon", int: 16, sp: 42, hit: 24 },
        { id: 33334, title: "Fetish of the Primal Gods", int: 17, sp: 37, haste: 17 },
        ...
        { id: 31978, title: "Merciless Gladiator's Endgame", int: 19, sp: 33 },
    ...
    ranged: [
        ...
        { id: 33192, title: "Carved Witch Doctor's Stick", int: 15, sp: 18, sockets: ["b"], bonus: { sp: 2 } },
    ...
    head: [
        ...
        { id: 33453, title: "Hood of Hexing", int: 33, sp: 56, crit: 24, hit: 31, sockets: ["r", "y", "b"], bonus: { sp: 5 } },
        ...
        { id: 35097, title: "Brutal Gladiator's Silk Cowl", int: 29, sp: 54, crit: 30, sockets: ["m", "r"] },
        ...
        { id: 33758, title: "Vengeful Gladiator's Silk Cowl", int: 23, sp: 47, crit: 24, sockets: ["m", "r"] },
    ...
    neck: [
        ...
        { id: 33281, title: "Brooch of Nature's Mercy", int: 24, spi: 19, sp: 25, haste: 33 },
        { id: 37928, title: "Guardian's Pendant of Subjugation", int: 18, sp: 28, haste: 24, sockets: ["y"] },
        { id: 35290, title: "Sin'dorei Pendant of Conquest", int: 19, sp: 34, crit: 19, sockets: ["b"], bonus: { sp: 2 } },
        { id: 33466, title: "Loop of Cursed Bones", int: 20, sp: 32, haste: 27 },
        ...
        { id: 33067, title: "Veteran's Pendant of Conquest", int: 12, sp: 21, crit: 18, sockets: ["y"] },
    ...
    shoulder: [
        ...
        { id: 32338, title: "Blood-cursed Shoulderpads", int: 19, sp: 55, crit: 25, hit: 18 },
        ...
        { id: 35096, title: "Brutal Gladiator's Silk Amice", int: 18, sp: 44, crit: 21, sockets: ["b", "y"] },
        ...
        { id: 33489, title: "Mantle of Ill Intent", int: 24, sp: 40, haste: 33 },
    ...
    back: [
        ...
        { id: 32524, title: "Shroud of the Highborne", int: 23, sp: 23, haste: 32 },
        { id: 33591, title: "Shadowcaster's Drape", int: 20, sp: 27, haste: 25 },
        ...
        { id: 33592, title: "Cloak of Ancient Rituals", int: 20, sp: 17, haste: 25 },
    ...
    chest: [
        ...
        { id: 33317, title: "Robe of Departed Spirits", int: 31, spi: 30, sp: 54, haste: 35 },
        ...
        { id: 28191, title: "Mana-Etched Vestments", int: 25, sp: 29, crit: 17, sockets: ["r", "b", "y"], bonus: { sp: 5 }, q: "rare" },
    ...
    wrist: [
        { id: 34447, itemset: ids.TEMPEST_SET, title: "Bracers of the Tempest", int: 17, spi: 14, sp: 39, crit: 11, haste: 26, sockets: ["r"], bonus: { crit: 2 } },
        ...
        { id: 33285, title: "Fury of the Ursine", int: 17, spi: 16, sp: 29, crit: 17, sockets: ["y"], bonus: { sp : 2 } },
        { id: 33913, title: "Vindicator's Silk Cuffs", int: 22, sp: 27, crit: 15, sockets: ["y"], bonus: { sp: 2 } },
        { id: 33588, title: "Runed Spell-cuffs", int: 18, sp: 29, haste: 25 },
    ...
    hands: [
        ...
        { id: 34406, title: "Gloves of Tyri's Power", int: 32, spi: 27, sp: 47, haste: 36, sockets: ["y", "r"], bonus: { sp: 4 } },
        ...
        { id: 33586, title: "Studious Wraps", int: 22, sp: 40, crit: 25, sockets: ["r", "b"], bonus: { sp: 4 } },
        { id: 29987, title: "Gauntlets of the Sun King", int: 29, spi: 20, sp: 42, crit: 28 },
        { id: 34808, title: "Gloves of Arcane Acuity", int: 20, sp: 34, hit: 18, sockets: ["b", "r"], bonus: { sp: 4 } },
        ...
        { id: 35098, title: "Brutal Gladiator's Silk Handguards", int: 23, sp: 44, crit: 26 },
    ...
    waist: [
        { id: 34557, itemset: ids.TEMPEST_SET, title: "Belt of the Tempest", int: 29, spi: 20, sp: 50, crit: 17, hit: 14, haste: 29, sockets: ["y"], bonus: { sp: 2 } },
        ...
        { id: 33291, title: "Voodoo-woven Belt", int: 22, sp: 40, crit: 33, hit: 17 },
        { id: 24256, title: "Girdle of Ruination", int: 13, sp: 39, crit: 20, sockets: ["r", "y"] },
        { id: 33912, title: "Vindicator's Silk Belt", int: 30, sp: 35, crit: 28 },
    ...
    legs: [
        ...
        { id: 31058, itemset: ids.TEMPEST_SET, title: "Leggings of the Tempest", int: 47, spi: 29, sp: 62, crit: 29, hit: 20, sockets: ["b"], bonus: { sp: 2 } },
        { id: 32367, title: "Leggings of Devastation", int: 42, sp: 60, hit: 26, sockets: ["y", "y", "b"], bonus: { sp: 5 } },
        { id: 34937, title: "Corrupted Soulcloth Pantaloons", int: 33, sp: 61, crit: 43, sockets: ["y", "b"], bonus: { sp: 4 } },
        { id: 34918, title: "Legwraps of Sweltering Flame", int: 36, spi: 30, sp: 62, hit: 25, sockets: ["y", "b"], bonus: { sp: 4 } },
        ...
        { id: 33584, title: "Pantaloons of Arcane Annihilation", int: 35, sp: 54, haste: 45 },
    ...
    feet: [
        { id: 34574, itemset: ids.TEMPEST_SET, title: "Boots of the Tempest", int: 29, spi: 20, sp: 50, crit: 20, hit: 15, haste: 25, sockets: ["y"], bonus: { sp: 2 } },
        ...
        { id: 30067, title: "Velvet Boots of the Guardian", int: 21, spi: 15, sp: 49, crit: 24 },
        { id: 30037, title: "Boots of Blasting", int: 25, sp: 39, crit: 25, hit: 18 },
        { id: 33357, title: "Footpads of Madness", int: 22, sp: 50, haste: 25 },
    ...
    finger: [
        ...
        { id: 33497, title: "Mana Attuned Band", int: 19, sp: 34, hit: 18, haste: 29 },
        ...
        { id: 34889, title: "Fused Nethergon Band", int: 19, sp: 35, hit: 28 },
        { id: ids.ETERNAL_SAGE, title: "Band of the Eternal Sage", int: 25, sp: 34, crit: 24 },
        { id: 33498, title: "Signet of the Quiet Forest", int: 17, sp: 21, haste: 30, mp5: 8 },
        { id: 29287, title: "Violet Signet of the Archmage", int: 23, sp: 29, crit: 17 },
        { id: 33293, title: "Signet of Ancient Magics", int: 17, sp: 29, mp5: 10, sockets: ["b"], bonus: { sp: 2 } },
    ...
    trinket: [
        ...
        { id: 35327, title: "Battlemaster's Alacrity", haste: 40 },
...
var gems = [
    ...
    { id: 35760, title: "Reckless Pyrestone", color: "o", sp: 6, haste: 5 },
    ...
    { id: 35761, title: "Quick Lionseye", color: "y", haste: 10 },
