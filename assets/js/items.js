...
var equip = {
    ...
    head: [
        { id: 33829, title: "Dark Conjuror's Collar", int: 42, sp: 75, crit: 38, haste: 30, sockets: ["m", "b"], bonus: { sp: 5 } },
    ...
    wrist: [
        { id: 34447, itemset: ids.TEMPEST_SET, title: "Bracers of the Tempest", int: 17, spi: 14, sp: 39, crit: 11, haste: 26, sockets: ["r"], bonus: { sp: 2 } },
    ...
    waist: [
        ...
        { id: 28799, title: "Vindicator's Silk Belt", int: 30, sp: 35, crit: 28 },
        { id: 33912, title: "Belt of Divine Inspiration", int: 26, sp: 43, sockets: ["b", "y"], bonus: { sp: 4 } },
    ...
    legs: [
        ...
        { id: 32367, title: "Leggings of Devastation", int: 42, sp: 60, hit: 26, sockets: ["y", "b"], bonus: { sp: 4 } },
        { id: 34937, title: "Corrupted Soulcloth Pantaloons", int: 33, sp: 61, crit: 43, sockets: ["y", "y", "b"], bonus: { sp: 5 } },
