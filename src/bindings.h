...
EMSCRIPTEN_BINDINGS(my_module) {
    ...
    emscripten::enum_<Trinket>("Trinket")
        ...
        .value("TRINKET_ESSENCE_MARTYR", TRINKET_ESSENCE_MARTYR)
        ...
        .value("TRINKET_CRIMSON_SERPENT", TRINKET_CRIMSON_SERPENT)
        ...
        .value("TRINKET_SMOKING_PIPE", TRINKET_SMOKING_PIPE)
        .value("TRINKET_SMOKING_PIPE_TBC_ANNI", TRINKET_SMOKING_PIPE_TBC_ANNI)
        .value("TRINKET_TIMBALS_FOCUSING_CRYSTAL", TRINKET_TIMBALS_FOCUSING_CRYSTAL)
        ;
    ...
    emscripten::class_<Config>("Config")
        ...
        .property("bis_ashtongue", &Config::bis_ashtongue)
